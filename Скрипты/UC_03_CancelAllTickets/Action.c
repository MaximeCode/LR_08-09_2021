Action()
{
	lr_start_transaction("UC_03_CancelAllTickets");
	...
	lr_start_transaction("cancelAll");
		...
		// Шаг работает, если в списке до 10 броней.
	...
	lr_end_transaction("cancelAll",LR_AUTO);
	...
	lr_end_transaction("UC_03_CancelAllTickets", LR_AUTO);
