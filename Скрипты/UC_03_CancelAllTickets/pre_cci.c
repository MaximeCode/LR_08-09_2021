# 1 "d:\\scripts\\uc_03_cancelalltickets\\\\combined_UC_03_CancelAllTickets.c"
...
# 1 "d:\\scripts\\uc_03_cancelalltickets\\\\combined_UC_03_CancelAllTickets.c" 2
...
# 2 "d:\\scripts\\uc_03_cancelalltickets\\\\combined_UC_03_CancelAllTickets.c" 2
...
# 3 "d:\\scripts\\uc_03_cancelalltickets\\\\combined_UC_03_CancelAllTickets.c" 2
...
# 4 "d:\\scripts\\uc_03_cancelalltickets\\\\combined_UC_03_CancelAllTickets.c" 2

# 1 "Action.c" 1
Action()
{
	lr_start_transaction("UC_03_CancelTickets");
	...
	lr_end_transaction("openWebTours", 2);
	...
	lr_start_transaction("cancelAll");
		...
		"Name=removeAllFlights.x", "Value={removeAllFlights_x}", "ENDITEM",
		"Name=removeAllFlights.y", "Value={removeAllFlights_y}", "ENDITEM",
		"LAST");

	lr_end_transaction("cancelAll",2);
	...
	lr_end_transaction("UC_03_CancelTickets", 2);

	return 0;
}
# 5 "d:\\scripts\\uc_03_cancelalltickets\\\\combined_UC_03_CancelAllTickets.c" 2
...
# 6 "d:\\scripts\\uc_03_cancelalltickets\\\\combined_UC_03_CancelAllTickets.c" 2
